...
import random
import math
from localSearch import * #hillClimb, stochHillClimb, simAnnealing, beamSearch, geneticAlg, randomRestartHC
...
# -------------------------------------
# These function help to walk through local search algorithms by hand


def simAnnealProb(deltaE, T):
    "Give this two inputs. The first is the difference between the current state's heuristic value "
    print("Probability for simulated annealing is", math.e ** (deltaE / T))
...
def NQGenerator():
    """This generates a random NQueens state, for use with beam search
...
if __name__ == "__main__":
    ...
    # Example call to beam search with N-Queens generator
    # stochBeamSearch(NQGenerator, 1000)
